...
<head>
  <meta charset="utf-8">
    ...
    <title>Innovative PNG Admin - Log in </title>
            ...
            @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" type="password" name="password" required autocomplete="current-password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
